                ...
                if ( infl_pofs.length > 0 && $(infl_pofs[0]).attr("context") == pofs)
                {
                    ...
                    {   
                        ...
                        if (map_pofs.indexOf('verb') == 0)
                        {
                            ...
                            {
                                $(".alph-pofs[context=" + pofs + "]", a_node).parents(".alph-entry").each(
                                    function() 
                                    {
                            ...
                            } else
                            {
                                ...
                                $(".alph-pofs[context='verb']", a_node).parents(".alph-entry").each(
                                    function() 
                                    {
                                        params.xslt_params.selected_endings.push($(this).get(0));
                                    }
                            ...
                            {
                                params.xml_url = 'chrome://alpheios-latin/content/inflections/alph-verb-conj-supp.xml';
                                params.xslt_url = 'chrome://alpheios-latin/skin/alph-verb-conj-supp.xsl';
                                var mood = $(".alph-mood",this).attr('context') || pofs;
                                // supines and participles don't have the .alph-mood element so need to pick
                            ...
                            {
                                params.xml_url = 'chrome://alpheios-latin/content/inflections/alph-verb-conj.xml';
                                params.xslt_url = 'chrome://alpheios/skin/alph-verb-conj-group.xsl';        
